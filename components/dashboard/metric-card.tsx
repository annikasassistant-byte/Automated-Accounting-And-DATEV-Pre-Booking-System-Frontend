...
export function MetricCard({
  ...
  return (
    <div
      className={cn(
        "group relative overflow-hidden rounded-2xl border border-border/40 bg-card/80 p-5 backdrop-blur-sm transition-shadow duration-300 hover:-translate-y-0.5",
        className
      )}
