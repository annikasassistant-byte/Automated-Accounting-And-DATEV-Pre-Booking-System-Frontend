        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-3 right-3 h-11 w-11 min-h-11 min-w-11"
                size="icon-sm"
              />
            }
          >
